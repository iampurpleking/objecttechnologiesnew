...
export default function AuthForm({ mode, redirectTo }: AuthFormProps) {
  ...
  useEffect(() => {
    ...
    const checkAuthAndRedirect = async () => {
      ...
      console.log('User authenticated, redirecting to:', redirectTo || '/dashboard');
      try {
  ...
  return (
    <div className="w-full">
      <form className="space-y-6" onSubmit={handleSubmit}>
        ...
        >
          {loading ? 'Please wait...' : mode === 'login' ? 'Sign In' : mode === 'register' ? 'Sign Up' : 'Reset Password'}
        </button>
      </form>
          ...
          {mode === 'login' ? (
            <>
              <p className="mb-4">
                ...
                <Link href="/get-started?mode=register" className="font-medium text-brand-orange hover:text-brand-orange-dark">
                  Sign up
                </Link>
              </p>
            </>
            ...
            <p>
              ...
              <Link href="/get-started?mode=login" className="font-medium text-brand-orange hover:text-brand-orange-dark">
                Sign in
              </Link>
            </p>
          )}
