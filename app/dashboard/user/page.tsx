  ...
  return (
    <main className="min-h-screen bg-brand-white text-brand-black flex flex-col items-center justify-center p-0 px-2 md:px-0">
      <section className="w-full max-w-4xl mx-auto py-10 md:py-20 px-2 md:px-4 text-center">
        <h1 className="text-4xl md:text-5xl font-bold text-brand-orange font-poppins mb-8">
          User Dashboard
        </h1>
        <div className="mb-6 text-lg font-poppins text-brand-black/80">
          Welcome, {user.email}!
        </div>
        <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
          <div className="bg-brand-orange/10 rounded-lg p-6 shadow">
            <h2 className="text-2xl font-bold text-brand-orange mb-2 font-poppins">
              Account
            </h2>
          ...
          <div className="bg-brand-orange/10 rounded-lg p-6 shadow">
            <h2 className="text-xl font-bold text-brand-orange mb-2 font-poppins">
              Project Updates
            </h2>
